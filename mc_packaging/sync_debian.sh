...
export FLAVORS="xenial bionic disco focal"
export RELEASES="${RELEASES:-"experimental|stable|unstable|precise|trusty|utopic|vivid|oneric|wily|xenial|artful|bionic|disco|focal"}"
